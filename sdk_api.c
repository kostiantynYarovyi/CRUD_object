...
crud_object_id_t check_type_object(crud_attribute_t* attr_list, uint32_t attr_count){
    ...
    for (uint32_t i = 0; i < attr_count; ++i){
        ...
        case CRUD_SWITCH_ATTR_NAME:
            //printf("sdk_api_check_type_object_0: set Switch type name\n");
            chekTypeSwitchObject = true;
            break;
        case CRUD_SWITCH_ATTR_HASH_SEED:
            //printf("sdk_api_check_type_object_1: set Switch type\n");
            chekTypeSwitchObject = true;
            break;
        case CRUD_SWITCH_ATTR_SPLIT_MODE:
            //printf("sdk_api_check_type_object_2: set Switch type\n");
            chekTypeSwitchObject = true;
            break;
        case CRUD_SWITCH_ATTR_MAX_PORTS:
            //printf("sdk_api_check_type_object_3: set Switch type\n");
            chekTypeSwitchObject = true;
            break;

        case CRUD_PORT_ATTR_STATE:
            //printf("sdk_api_check_type_object_4: set Port type bool\n");
            chekTypePortObject = true;
            break;
        case CRUD_PORT_ATTR_SPEED:
            //printf("sdk_api_check_type_object_5: set Port type\n");
            chekTypePortObject = true;
            break;
        case CRUD_PORT_ATTR_IPV4:
            //printf("sdk_api_check_type_object_6: set Port type\n");
            chekTypePortObject = true;
            break;
        case CRUD_PORT_ATTR_MTU:
            //printf("sdk_api_check_type_object_7: set Port type\n");
            chekTypePortObject = true;
            break;
        default:
            printf("sdk_api_check_type_object: CRUD_INVALID_PARAM\n");
            return 0;
        }
    }
